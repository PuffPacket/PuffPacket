...
//        uuid = (__bridge_transfer NSString *)CFUUIDCreateString(NULL,[NSString]peripheral.identifier.UUIDString));
//    } else {
//        uuid = @"";
//    }
    ...
    if (manufacturerData) {
        ...
        NSInteger len = [manufacturerData length];
...
{
    NSLog(@"central manager stlde =(long) %ld", (long)[central state]);
